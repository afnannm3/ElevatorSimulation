...
QT_MOC_LITERAL(1, 10, 17), // "elevatorRequested"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 5), // "floor"
QT_MOC_LITERAL(4, 35, 9), // "direction"
QT_MOC_LITERAL(5, 45, 17) // "helpButtonPressed"

    },
    "Passenger\0elevatorRequested\0\0floor\0"
    "direction\0helpButtonPressed"
};
...
void Passenger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->elevatorRequested((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (Passenger::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Passenger::elevatorRequested)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Passenger::helpButtonPressed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Passenger::elevatorRequested(int _t1, int _t2)
{
...
// SIGNAL 1
void Passenger::helpButtonPressed()
{
