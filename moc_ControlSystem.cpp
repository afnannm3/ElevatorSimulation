...
QT_MOC_LITERAL(1, 14, 19), // "updateSimulationLog"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 10) // "logMessage"

    },
    "ControlSystem\0updateSimulationLog\0\0"
    "logMessage"
};
...
void ControlSystem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updateSimulationLog((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ControlSystem::updateSimulationLog)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ControlSystem::updateSimulationLog(const QString & _t1)
{
