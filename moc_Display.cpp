...
QT_MOC_LITERAL(1, 8, 14), // "displayUpdated"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 12), // "currentFloor"
QT_MOC_LITERAL(4, 37, 14) // "warningMessage"

    },
    "Display\0displayUpdated\0\0currentFloor\0"
    "warningMessage"
};
...
void Display::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->displayUpdated((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Display::*)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Display::displayUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Display::displayUpdated(int _t1, QString _t2)
{
